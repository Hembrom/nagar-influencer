      ...
      <div className="grid grid-cols-5 gap-6 overflow-x-auto pb-4">
        ...
        <div>
          <div className="text-sm font-semibold text-gray-400 mb-4">
            BRIEF RECEIVED <span className="text-orange-400">1</span>
          </div>
          <div className="space-y-3">
            {CAMPAIGNS_DATA.brief_received.map((campaign) => (
              <div key={campaign.id} className="bg-[#131829] border border-[#1e2847] rounded-lg p-4 cursor-pointer hover:border-orange-500 transition">
                <p className="text-sm font-semibold text-white mb-2">{campaign.name}</p>
                <p className="text-xs text-gray-500 mb-3">{campaign.brand}</p>
                <p className="text-xs font-medium text-orange-400">{campaign.budget}</p>
                <div className="mt-3 w-full bg-[#0a0e27] rounded-full h-1">
                  <div className="bg-gradient-to-r from-orange-500 to-orange-400 h-1 rounded-full" style={{ width: "75%" }}></div>
                </div>
                <p className="text-xs text-gray-500 mt-2">{campaign.status}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="text-sm font-semibold text-gray-400 mb-4">
            SHORTLISTING <span className="text-orange-400">1</span>
          </div>
          <div className="space-y-3">
            {CAMPAIGNS_DATA.shortlisting.map((campaign) => (
              <div key={campaign.id} className="bg-[#131829] border border-[#1e2847] rounded-lg p-4 cursor-pointer hover:border-orange-500 transition">
                ...
                <p className="text-xs text-gray-500 mb-3">{campaign.brand}</p>
                <p className="text-xs font-medium text-orange-400">{campaign.budget}</p>
                <p className="text-xs text-gray-500 mt-3">{campaign.status}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div className="text-sm font-semibold text-gray-400 mb-4">
            NEGOTIATING <span className="text-orange-400">1</span>
          </div>
          <div className="space-y-3">
        ...
        <div>
          <div className="text-sm font-semibold text-gray-400 mb-4">
            LIVE <span className="text-orange-400">1</span>
          </div>
          <div className="space-y-3">
        ...
        <div>
          <div className="text-sm font-semibold text-gray-400 mb-4">
            REPORT DUE <span className="text-orange-400">1</span>
          </div>
          <div className="space-y-3">
