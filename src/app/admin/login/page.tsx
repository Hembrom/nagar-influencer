        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Admin"
                className="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition"
              />
            </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-600 text-center">
              Demo Credentials:<br />
              <span className="text-gray-700">Username: Admin</span><br />
              <span className="text-gray-700">Password: Admin</span>
            </p>
          </div>
        </div>
      </div>
