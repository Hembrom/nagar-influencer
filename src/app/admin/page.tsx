  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-2">Welcome back to your admin panel</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-[#131829] border border-[#1e2847] rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-white">₹28.5L</p>
          <p className="text-xs text-green-400 mt-2">+12% this month</p>
        </div>
        <div className="bg-[#131829] border border-[#1e2847] rounded-lg p-6">
          <p className="text-sm text-gray-400 mb-2">Active Influencers</p>
